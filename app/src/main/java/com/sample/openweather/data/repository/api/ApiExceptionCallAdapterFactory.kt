...
class ApiExceptionCallAdapterFactory(
    ...
    override fun get(
        ...
        return ApiExceptionCallAdapter(gson, nextCallAdapter)
    }
}
...
private class ApiExceptionCallAdapter<Response, Type>(
    ...
    override fun adapt(call: Call<Response>): Type = delegate.adapt(ApiExceptionCall(gson, call))
...
private class ApiExceptionCall<Response>(
    ...
    override fun clone(): Call<Response> = ApiExceptionCall(gson, delegate.clone())
    ...
    private fun mapUnsuccessfulResponseToApiException(response: retrofit2.Response<Response>): ApiException {
        ...
        return try {
            val exception = gson.fromJson(errorBodyString, ApiException::class.java)
            exception
